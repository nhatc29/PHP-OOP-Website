    ...
    <div class="container clearpadding" >
            ...
            <div class="panel panel-info ">
              <div class="panel-heading">
                <h3 class="panel-title text-left">Thông tin người dùng</h3>
              </div>
        ...
        ?>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-7">
                      <button type="submit" class="btn btn-info" name="suathongtin"><a href="editprofile.php">Cập nhật thông tin</a></button>
                    </div>
                  </div>
                </form>		
                <?php } } ?>		  	
