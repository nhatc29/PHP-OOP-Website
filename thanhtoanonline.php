		...
		<table class="table table-hover" >
					...
					<div class="panel panel-info ">
					  ...
					  <div class="panel-body">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="hidden" name="total_congthanhtoan" value="<?php echo $tongtien ?>">
                        <button class="btn btn-info" name="redirect" id="redirect"> Thanh toán QR MOMO </button>
                        &nbsp;&nbsp;
